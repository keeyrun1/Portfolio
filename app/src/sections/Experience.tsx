...
const EXPERIENCE_DATA = [
  {
    ...
    location: 'Canada',
    responsibilities: [
      'Led the SDLC for web-based intranet and Risk Monitoring applications using .NET, C#, PCF, and Harness, delivering secure and scalable enterprise solutions.',
      'Created Splunk dashboards to improve portfolio visibility, support analytics, and real-time operational monitoring.',
      'Orchestrated Agile Scrum ceremonies across offshore and onsite teams, ensuring smooth collaboration, delivery alignment, and continuous improvement.',
      'Performed code reviews and resolved critical technical issues while supporting high-quality production delivery.',
      'Leveraged automation-focused practices and AI-driven thinking to reduce manual effort, optimize workflows, and improve engineering productivity.',
      'Designed and implemented configurable, event-driven thresholds to optimize Kafka message processing based on business needs and volatile market conditions, achieving a 50% reduction in message volume while maintaining service continuity and cost efficiency.',
    ],
